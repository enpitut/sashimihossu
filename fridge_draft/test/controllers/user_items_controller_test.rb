...
class UserItemsControllerTest < ActionController::TestCase
  ...
  test "should create user_item" do
    assert_difference('UserItem.count') do
      post :create, user_item: { amount: @user_item.amount, end: @user_item.end, gram: @user_item.gram, item_id: @user_item.item_id, start: @user_item.start, title: @user_item.title, user_id: @user_item.user_id }
    end
  ...
  test "should update user_item" do
    patch :update, id: @user_item, user_item: { amount: @user_item.amount, end: @user_item.end, gram: @user_item.gram, item_id: @user_item.item_id, start: @user_item.start, title: @user_item.title, user_id: @user_item.user_id }
    assert_redirected_to user_item_path(assigns(:user_item))
  end
